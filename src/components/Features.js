...
const Features = () => {
  return (
    ...
    <View className="bg-emerald-200 p-4 rounded-xl space-y-2">
        ...
        <Image style={{width:hp(4),height:hp(4)}}  source={require("../../assets/images/chatgpt.png")}/>
...
ChatGPT can provide you with instant and knowledgable sesponses,assist you with creative ideas on a wide range of topics
        </Text>
    </View>

    <View className="bg-purple-200 p-4 rounded-xl space-y-2">
        <View className="flex-row items-center space-x-1">
        <Image style={{width:hp(4.5),height:hp(4.5)}}  source={require("../../assets/images/DALL-E.png")}/>
...
DALL-E can generate imaginative and diverse images from textual descriptions,expanding the boundaries of visual creativity
    ...
    <View className="bg-cyan-200 p-4 rounded-xl space-y-2">
        <View className="flex-row items-center space-x-1">
        <Image style={{width:hp(4.5),height:hp(4.5)}}  source={require("../../assets/images/smart-ai.png")}/>
